...
const TestABI = "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"bytes32\",\"name\":\"key\",\"type\":\"bytes32\"},{\"indexed\":false,\"internalType\":\"bytes32\",\"name\":\"value\",\"type\":\"bytes32\"}],\"name\":\"ItemSet\",\"type\":\"event\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"name\":\"items\",\"outputs\":[{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"key\",\"type\":\"bytes32\"},{\"internalType\":\"bytes32\",\"name\":\"value\",\"type\":\"bytes32\"}],\"name\":\"setItem\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"version\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"
...
var TestBin = ""
...
func (_Test *TestTransactor) SetItem(opts *bind.TransactOpts, key [32]byte, value [32]byte) (*types.Transaction, error) {
	return _Test.contract.Transact(opts, "setItem", key, value)
}

// SetItem is a paid mutator transaction binding the contract method 0xf56256c7.
//
// Solidity: function setItem(bytes32 key, bytes32 value) returns()
func (_Test *TestSession) SetItem(key [32]byte, value [32]byte) (*types.Transaction, error) {
	return _Test.Contract.SetItem(&_Test.TransactOpts, key, value)
}

// SetItem is a paid mutator transaction binding the contract method 0xf56256c7.
//
// Solidity: function setItem(bytes32 key, bytes32 value) returns()
func (_Test *TestTransactorSession) SetItem(key [32]byte, value [32]byte) (*types.Transaction, error) {
	return _Test.Contract.SetItem(&_Test.TransactOpts, key, value)
}

// TestItemSetIterator is returned from FilterItemSet and is used to iterate over the raw logs and unpacked data for ItemSet events raised by the Test contract.
type TestItemSetIterator struct {
	Event *TestItemSet // Event containing the contract specifics and raw log
...
func (it *TestItemSetIterator) Next() bool {
...
func (it *TestItemSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TestItemSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TestItemSet represents a ItemSet event raised by the Test contract.
type TestItemSet struct {
	Key   [32]byte
	Value [32]byte
...
func (_Test *TestFilterer) FilterItemSet(opts *bind.FilterOpts) (*TestItemSetIterator, error) {

	logs, sub, err := _Test.contract.FilterLogs(opts, "ItemSet")
	if err != nil {
		return nil, err
	}
	return &TestItemSetIterator{contract: _Test.contract, event: "ItemSet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ItemSet(bytes32 key, bytes32 value)
func (_Test *TestFilterer) WatchItemSet(opts *bind.WatchOpts, sink chan<- *TestItemSet) (event.Subscription, error) {

	logs, sub, err := _Test.contract.WatchLogs(opts, "ItemSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TestItemSet)
				if err := _Test.contract.UnpackLog(event, "ItemSet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ItemSet(bytes32 key, bytes32 value)
func (_Test *TestFilterer) ParseItemSet(log types.Log) (*TestItemSet, error) {
	event := new(TestItemSet)
	if err := _Test.contract.UnpackLog(event, "ItemSet", log); err != nil {
		return nil, err
	}
